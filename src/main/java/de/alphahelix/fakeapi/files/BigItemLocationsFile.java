...
public class BigItemLocationsFile extends SimpleFile<FakeAPI> {
    ...
    /**
     * Adds a new {@link de.alphahelix.fakeapi.instances.FakeBigItem} to the file
     *
     * @param loc  {@link Location} where the {@link de.alphahelix.fakeapi.instances.FakeBigItem} is located at
     * @param name of the {@link de.alphahelix.fakeapi.instances.FakeBigItem}
    ...
    /**
     * Gets all {@link de.alphahelix.fakeapi.instances.FakeBigItem} from the file and returns it as a {@link HashMap}
     *
    ...
    /**
     * Gets all {@link Material}s of the {@link de.alphahelix.fakeapi.instances.FakeBigItem}s from the file and returns it as a {@link HashMap}
     *
