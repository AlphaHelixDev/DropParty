...
public class MobLocationsFile extends SimpleFile<FakeAPI> {
    ...
    /**
     * Adds a new {@link de.alphahelix.fakeapi.instances.FakeMob} to the file
     *
     * @param loc         {@link org.bukkit.Location} where the {@link de.alphahelix.fakeapi.instances.FakeMob} is located at
     * @param name        of the {@link de.alphahelix.fakeapi.instances.FakeMob}
    ...
    /**
     * Gets all {@link de.alphahelix.fakeapi.instances.FakeMob} from the file and returns it as a {@link HashMap}
     *
    ...
    /**
     * Gets all {@link FakeMobType}s of the {@link de.alphahelix.fakeapi.instances.FakeMob}s from the file and returns it as a {@link HashMap}
     *
